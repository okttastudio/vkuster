...
slickItemPreset('.carousel-multiple-two', {
    p480: 1.25,
    p600: 1.2,
    p769: 2.25,
    p1025: 2.25
...
;// CONCATENATED MODULE: ./assets/js/range.js

jquery_default()('input[type=range]').on('input', function(e){
    let min = e.target.min,
        max = e.target.max,
        val = e.target.value;

    jquery_default()(e.target).css({
        'backgroundSize': (val - min) * 100 / (max - min) + '% 100%'
    });
}).trigger('input');
// EXTERNAL MODULE: ./assets/js/validation.js
var validation = __webpack_require__(906);
;// CONCATENATED MODULE: ./assets/js/radiocheck.js
...
jquery_default()('.allow-focus').on("click.bs.dropdown", function (e) {
    e.stopPropagation();
    // e.preventDefault();
});
;// CONCATENATED MODULE: ./assets/js/upload.js


jquery_default()('.vkuster-file-input').on("change", function () {
    const name = jquery_default()(this).val().replace(/^.*?([^\\\/]*)$/, '$1');
    ...
    jquery_default()('.vkuster-file-name').text(name ? name : "Прикрепите файл");
    jquery_default()('.vkuster-file-size').text(exactSize);
});
;// CONCATENATED MODULE: ./assets/js/header.js

const h = jquery_default()('.header-main-menu');
const hInner = h.find('.hmm-inner');
const header = jquery_default()('header');
// console.log(header.offset(), header.height());
const vNavigator = jquery_default()('.vkuster-navigator, .vkuster-end-navigator');
const vMobileMenu = jquery_default()('#sidebarMenu');
const vOffsetSearch = jquery_default()('.offcanvas-search');
const vOffsetCatalog = jquery_default()('.offcanvas-catalog');
...
jquery_default()(window).scroll(() => {
    if (jquery_default()(window).scrollTop() + 1 >= header.offset().top + header.height() - h.innerHeight()) {
...
;// CONCATENATED MODULE: ./assets/js/mask.js
...
var animate = __webpack_require__(572);
...
// EXTERNAL MODULE: ./node_modules/wow.js/css/libs/animate.css
var libs_animate = __webpack_require__(143);
;// CONCATENATED MODULE: ./assets/js/wow.js



window.wow = new (wow_default())();
window.wow.init();
...
/******/ 			// return url for filenames based on template
/******/ 			return "css/" + (chunkId === 179 ? "main" : chunkId) + ".css";
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ 	!function() {
/******/ 		__webpack_require__.h = function() { return "d99d0065c1d612d74375"; }
/******/ 	}();
/******/ 	
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, [724], function() { return __webpack_require__(918); })
...
document.getElementById('promo-close').onclick = function() {
    document.getElementById('bg-vkuster-promo').classList.add('promo-off');
};
